...
must_haves:
  truths:
    ...
    - "Materials panel has category tabs: All, Hardwood, Softwood, Exotic, Composite"
...
<task type="auto">
  ...
  <action>
    ...
    2. Implement materials_panel.cpp with these sections:
       ...
       **renderCategoryTabs():**
       ...
       - Tabs: "All", "Hardwood", "Softwood", "Exotic", "Composite"
       ...
       **renderMaterialGrid(const vector<MaterialRecord>& materials):**
       ...
       - For each material:
         ...
         - Else show colored placeholder rectangle with category initial (H/S/E/C)
       ...
       **renderEditForm():**
       ...
       - All fields editable (per user decision: "All fields in the material record must be editable"):
         ...
         - Category: ImGui::Combo (Hardwood/Softwood/Exotic/Composite)
  ...
  <done>
    MaterialsPanel renders with category tabs (All/Hardwood/Softwood/Exotic/Composite), thumbnail grid, toolbar (import/export/add/delete), search filter, and inline edit form for all material properties. Single-click selects, double-click assigns. All material fields editable.
  </done>
</task>
