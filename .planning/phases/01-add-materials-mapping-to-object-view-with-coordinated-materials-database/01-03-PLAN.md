...
must_haves:
  truths:
    - "App ships with 30-35 built-in default materials covering hardwoods, softwoods, domestic woods, and composites"
...
<task type="auto">
  ...
  <action>
    ...
    2. Create default_materials.h/cpp with getDefaultMaterials() -> std::vector of MaterialRecord:
       Ship ~32 materials with real Janka ratings (from Wood Database) and conservative CNC defaults:
       ...
       **Domestic (7):** (common North American woods)
       - Soft Maple: Janka 950, feed 90, spindle 18000, doc 0.150, $3.50/bf
       - Poplar: Janka 540, feed 120, spindle 16000, doc 0.200, $2.50/bf
       - Alder: Janka 590, feed 110, spindle 16000, doc 0.200, $3.00/bf
       - Beech: Janka 1300, feed 75, spindle 18000, doc 0.100, $4.00/bf
       - Basswood: Janka 410, feed 140, spindle 14000, doc 0.250, $3.00/bf
       - Butternut: Janka 490, feed 120, spindle 16000, doc 0.200, $5.00/bf
       - Cottonwood: Janka 430, feed 130, spindle 16000, doc 0.200, $2.00/bf

       **Composites (10):** (MDF, HDF, plywood, non-ferrous metals, plastics, foams)
       - MDF: Janka 0 (N/A), feed 100, spindle 18000, doc 0.125, $1.50/bf
       - HDF: Janka 0, feed 90, spindle 18000, doc 0.100, $2.00/bf
       ...
       - Aluminum (6061): Janka 0, feed 30, spindle 10000, doc 0.050, $0/bf
       - Brass: Janka 0, feed 25, spindle 8000, doc 0.040, $0/bf
       - HDPE: Janka 0, feed 120, spindle 16000, doc 0.200, $0/bf
       - Acrylic: Janka 0, feed 60, spindle 12000, doc 0.100, $0/bf
       - Rigid Foam (PVC): Janka 0, feed 150, spindle 14000, doc 0.300, $0/bf
  ...
  <verify>
    ...
    Compiles. getDefaultMaterials() returns 32 materials.
  </verify>
  <done>
    Default materials list with 32 materials defined (8 hardwood, 7 softwood, 7 domestic, 10 composite). getMaterialsDir() added to app_paths. All compiles.
  </done>
</task>
...
3. Default materials list has ~32 entries covering hardwoods, softwoods, domestic woods, and composites (incl. metals, plastics, foams)
...
<success_criteria>
- 32 built-in materials with real Janka hardness ratings (where applicable)
