...
<task type="auto">
  ...
  <action>
    ...
    2. Modify renderMaterialInfo() in properties_panel.cpp:
       ...
       - Show category badge (Hardwood/Softwood/Exotic/Composite)
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <action>
    ...
    Complete materials system — MaterialsPanel with 23 default wood species, material assignment to 3D objects with texture mapping, grain direction control, material property display in PropertiesPanel, .dwmat import/export.

    Steps to verify:
    1. Launch the application: `./build/digital_workshop`
    2. Open the Materials panel from the View menu — verify 23 species appear with category tabs
    3. Switch between category tabs (All/Hardwood/Softwood/Exotic/Composite) — verify filtering works
...
3. 23 default species visible in MaterialsPanel
