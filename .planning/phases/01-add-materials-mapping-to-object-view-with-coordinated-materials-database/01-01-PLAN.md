...
must_haves:
  truths:
    ...
    - "MaterialCategory enum covers hardwood, softwood, exotic, composite groupings"
...
<task type="auto">
  ...
  <action>
    ...
    3. Create src/core/materials/material.h with:
       - MaterialCategory enum: Hardwood, Softwood, Exotic, Composite (per user decision: hardwood, softwood, exotic, domestic mapped to Composite for composites like MDF/plywood)
       - Note: User said "domestic" as a category but also separately listed "composite woods (MDF, plywood)". The categories hardwood/softwood/exotic cover domestic species. Composite covers MDF/plywood/particleboard. Use these 4 categories.
...
4. MaterialCategory covers hardwood, softwood, exotic, composite
